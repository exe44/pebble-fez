...
const SETTING_KEYS = [
  ...
  'SETTING_BG_COLOR',
  'SETTING_FACE_COLOR',
  'SETTING_SPLIT_FACE_COLORS',
  'SETTING_FACE_COLOR_1',
  'SETTING_FACE_COLOR_2',
  'SETTING_FACE_COLOR_3',
  'SETTING_FACE_COLOR_4',
...
function normalizeSettings(raw) {
  return {
    ...
    SETTING_SPLIT_FACE_COLORS: !!raw.SETTING_SPLIT_FACE_COLORS,
    SETTING_FACE_COLOR_1: parseColor(raw.SETTING_FACE_COLOR_1),
    SETTING_FACE_COLOR_2: parseColor(raw.SETTING_FACE_COLOR_2),
    SETTING_FACE_COLOR_3: parseColor(raw.SETTING_FACE_COLOR_3),
    SETTING_FACE_COLOR_4: parseColor(raw.SETTING_FACE_COLOR_4),
    ...
    SETTING_THICK_LINES: !!raw.SETTING_THICK_LINES
  };
}
